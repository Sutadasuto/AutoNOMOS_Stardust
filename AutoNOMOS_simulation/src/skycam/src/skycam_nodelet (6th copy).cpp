	...
	sky_image = cv_ptr_1->image;                
        ...
        if(flag == 2)
        {
                ...
                else
                {
                        ...
                        int direction = velocity.data/abs(velocity.data);                        
                        velocity.data = velocity.data * (1 - (exp(abs(steering.data) * log(1.8)/70) - 1));                                              
        ...
        {       
                ...
                {       
                        ...
                        if(flag == true)
                        {
                                ...
                                ROS_INFO_STREAM("Original expectedCost: " << expectedCost);
                                bool flag2 = false;
                                for(int i2 = 1; i2 <= 20; i2++)
                                {
                                        for(int i1 = 1; i1 <= 2; i1++)
                                        {
                                                ...
                                                if(pixel == 255)
                                                {
                                                        expectedCost = expectedCost + (20 - i2);
                                                        flag2 = true;
                                                        break;
                                                }
                                        }
                                ...
                                if(flag2 == false) expectedCost = expectedCost + (20 - 40);
                                //flag2 = false;
                                //for(int i2 = 1; i2 <= 20; i2++)
                                //{
                                ...
                                //}
                                //if(flag2 == false) expectedCost = expectedCost + (20 - 40);
                                ROS_INFO_STREAM("Modified expectedCost: " << expectedCost);
